...
export const createLevel23: LevelFactory = (world) => {
  ...
  // Platform and Star
  const horizontalDownPlatform = Matter.Bodies.rectangle(150, 450, 200, 150, { isStatic: true, label: 'horizontal_down_platform', render: { fillStyle: '#6b7280' }, collisionFilter: {category: 0x0002, mask: 0xFFFF & ~0x0002 } });
  ...
  const nail7_0 = Matter.Bodies.circle(230, 410, 10, { isStatic: true, label: 'nail7_0', collisionFilter: {category: 0x0002, mask: 0x0001 }, render: { fillStyle: 'rgba(0,0,0,0)', strokeStyle: '#fbbf24', lineWidth: 3 } });
  ...
  const nail7_1 = Matter.Bodies.circle(70, 410, 10, { isStatic: true, label: 'nail7_1', collisionFilter: {category: 0x0002, mask: 0x0001 }, render: { fillStyle: 'rgba(0,0,0,0)', strokeStyle: '#fbbf24', lineWidth: 3 } });
